...
markdown << "----\n\n"
markdown << "@copilot\n\n"
markdown << "Please help with the following, based on the dependency changes above:\n\n"
markdown << "1. **Fix failing CI/CD workflows** caused by these dependency upgrades.\n"
markdown << "   - Identify where these gems are used in the codebase.\n"
markdown << "   - Update or add code to keep existing behavior working for current versions.\n"
markdown << "   - For any version-specific changes (new APIs, callbacks, controller changes, configs):\n"
markdown << "     - Implement the necessary code updates.\n"
markdown << "     - Add comments explaining what changed in the upgraded dependency version.\n"
markdown << "     - Link to the relevant changelog entries.\n"
markdown << "\n"
markdown << "2. **Changelog and docs updates**:\n"
markdown << "   - Update or create `docs/dependency-upgrades-changelog.md` (or similar) describing:\n"
markdown << "     - Which dependencies changed and why.\n"
markdown << "     - What code paths or features were updated.\n"
markdown << "     - Any behavioral differences users or developers should know about.\n"
markdown << "\n"
markdown << "3. **Dependency pattern review**:\n"
markdown << "   - Check that any version-conditional code follows our `dependency_upgraded_next` pattern.\n"
markdown << "\n"
markdown << "4. **PR handling**:\n"
markdown << "   - Open a draft PR with these changes first, then later mark it 'ready for review'.\n"
markdown << "   - Ensure all CI checks pass before marking the PR ready.\n"
